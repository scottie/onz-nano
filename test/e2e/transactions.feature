Feature: Transactions tab
  ...
  Scenario: should provide "Receive ONZ" modal if there are "No transactions" 
    Given I'm logged in as "empty account"
    When I click tab number 1
    And I should see table with 0 lines
    And I should see text "There are no transactions, yet.  RECEIVE ONZ" in "empty message" element
    And I click "receive onz button"
    And I wait 1 seconds
