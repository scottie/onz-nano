      ...
      <div className='box noPaddingBox verticalScroll'>
        {this.props.transactions.length > 0 ?
          ...
          <p className={`${styles.empty} hasPaddingRow empty-message`}>
            ...
            <RelativeLink className={`${styles.button} ${buttonStyle.button} ${buttonStyle.primary} ${buttonStyle.raised} receive-onz-button ${offlineStyle.disableWhenOffline}`}
              to='receive'>{this.props.t('Receive ONZ')}</RelativeLink>
          </p>
        }
